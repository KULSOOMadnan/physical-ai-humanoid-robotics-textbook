...
sidebar_label: Chapter 6 - Proprioception & Tactile Sensing
...
With a comprehensive understanding of the various sensory modalities (vision, sensor fusion, proprioception, tactile), we now have the tools to perceive the world. The next phase focuses on how robots use this perception to plan and execute actions. Chapter 10 will introduce Reinforcement Learning for Robot Control, a powerful method for learning complex behaviors.