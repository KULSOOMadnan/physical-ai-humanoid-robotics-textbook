...
1.  **Given** a student has basic AI knowledge, **When** they read Chapters 1-3, **Then** they can explain the fundamental concepts of Physical AI and humanoid robotics architectures.
2.  **Given** a student has completed the foundation chapters, **When** presented with various AI scenarios (digital vs. physical), **Then** they can identify if the scenario involves embodied AI.
...
1.  **Given** a student has understood kinematics and dynamics concepts, **When** they complete the practical exercises in Chapters 7-9, **Then** they can control a simulated humanoid robot to perform basic movements (e.g., stand, walk a few steps).
...
1.  **Given** a student has access to simulated sensor data (e.g., camera feed, joint positions), **When** they complete exercises in Chapters 4-6, **Then** they can apply sensor fusion techniques to build a coherent understanding of the robot's state and environment.
...
1.  **Given** a simulated humanoid robot and a target location, **When** the student applies motion planning algorithms (Chapters 7-9), **Then** the robot can navigate to the target while avoiding obstacles.
...
1.  **Given** a student has developed behaviors in simulation, **When** they study Chapters 10-12 and 13-15, **Then** they can identify the primary factors affecting successful transfer to real hardware.
...
1.  **Given** a scenario involving a humanoid robot and a human, **When** the student analyzes Chapter 13-15, **Then** they can identify potential safety risks and propose mitigation strategies.
